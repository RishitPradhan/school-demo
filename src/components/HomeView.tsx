...
export default function HomeView({ onNavigateToTab, onOpenApply, onVideoLoaded }: HomeViewProps) {
  ...
  return (
    <div id="home-view-container" className="">
      ...
      {/* 1. Hero Section */}
      <section id="hero-banner" className="relative bg-slate-900 text-white h-[100dvh] flex items-center">
        {/* Background Video Loop with Overlay */}
        <div className="absolute -top-24 bottom-0 left-0 right-0 z-0 overflow-hidden">
          <video
            autoPlay
            loop
            muted
